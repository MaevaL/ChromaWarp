...
public class AttackTriggerControllerFollowerEnemy : MonoBehaviour {
    ...
    private void Start() {
        ...
        InvokeRepeating("EnableTriggerAttack", 1f, 2f);
    }

    void EnableTriggerAttack() {
        attackTrigger.enabled = true;
        Invoke("DisableTriggerAttack", 0.1f);
    }

    void DisableTriggerAttack() {
        attackTrigger.enabled = false;
    }
